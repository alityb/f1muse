...
- Local verification: `npm run typecheck` passed; `npm run lint` passed with 0 errors and 117 pre-existing warnings; `npm run test:f1ql` passed 172 tests in 12 files. Guarded Railway production golden execution is rerun after this coverage-boundary correction.
