...
- Expanded the bounded production manifest from 18 to 28 programs: three structural and 25 FIA/Formula 1-cited factual cases. New FIA-cited 2025 checks cover final Drivers' Championship P2 Max Verstappen (421), P3 Oscar Piastri (410), and P20 Franco Colapinto (0), all restricted to `f1ql.driver_standings` with recorded `MAX` measures rather than race-point sums.
- New canonical `f1ql.event_classification` checks cover Australian GP P2 Max Verstappen (18), P3 George Russell (15), Fernando Alonso DNF (null position, 0), Isack Hadjar DNS (null position, 0), and Las Vegas GP Lando Norris DSQ (null position, 0). New canonical `f1ql.qualifying_classification` checks cover Australian GP P2 Oscar Piastri and P3 Max Verstappen; the existing cited Australian qualifying metadata check remains included.
...
- Local verification: `npm run typecheck` passed; `npm run lint` passed with 0 errors and 117 pre-existing warnings; `npm run test:f1ql` passed 172 tests in 12 files. Guarded Railway production golden execution is pending the committed milestone.
