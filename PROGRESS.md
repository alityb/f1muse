...
- Local verification: `npm run typecheck` passed; `npm run test:f1ql` passed 172 tests in 12 files; `npm run lint` passed with 0 errors and 117 pre-existing warnings. Production execution is pending the committed guarded Railway run.
