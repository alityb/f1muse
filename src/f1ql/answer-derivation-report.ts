...
export function buildAnswerDerivationReport(
  ...
  const gates = {
    ...
    actions_and_reasons_exact: counts.actions_correct === 100 && counts.reasons_correct === 100 && counts.cases === 100,
    templates_programs_and_proofs_exact: counts.templates_exact === 65 && counts.programs_exact === 65 && counts.programs_required === 65 && counts.proofs_complete === 65,
