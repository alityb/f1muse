...
export function buildAnswerDerivationReport(
  ...
  const gates = {
    ...
    actions_and_reasons_exact: counts.actions_correct === 96 && counts.reasons_correct === 96 && counts.cases === 96,
    templates_programs_and_proofs_exact: counts.templates_exact === 61 && counts.programs_exact === 61 && counts.programs_required === 61 && counts.proofs_complete === 61,
