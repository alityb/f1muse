...
export const SEMANTIC_CANDIDATE_PROVIDER_SYSTEM_PROMPT =
  `${SEMANTIC_CANDIDATE_EFFECTIVE_SYSTEM_PROMPT} ${STANDINGS_SUMMARY_FAMILY_PROMPT} ${EVENT_METADATA_SCALAR_FAMILY_PROMPT} ${SELECTED_RACE_METADATA_JOIN_FAMILY_PROMPT} ${RACE_POSITION_RANKING_FAMILY_PROMPT} ${QUALIFYING_POSITION_RANKING_FAMILY_PROMPT}`;
