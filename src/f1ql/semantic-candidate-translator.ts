...
export const SEMANTIC_CANDIDATE_PROVIDER_SYSTEM_PROMPT =
  `${SEMANTIC_CANDIDATE_EFFECTIVE_SYSTEM_PROMPT} ${EVENT_METADATA_SCALAR_FAMILY_PROMPT} ${RACE_POSITION_RANKING_FAMILY_PROMPT} ${QUALIFYING_POSITION_RANKING_FAMILY_PROMPT}`;
