...
export const WP12_OFFICIAL_TIMING_PROVIDER_SCHEMA_TARGET = deepFreeze(componentSchema.parse({
  ...
  contract: {
    ...
    generated_artifacts: {
      ...
      catalog_language_projection_sha256: null,
      effective_prompt_sha256: null,
      openai_compatible_schema_sha256: null,
      anthropic_wire_schema_sha256: null,
      provider_request_config_sha256: null
    },
...
export const WP12_OFFICIAL_TIMING_RESPONSE_EQUIVALENCE_TARGET = component('semantic_response_equivalence', {
  ...
  official_timing_overlaps: outputs.map(output => ({
    ...
    status: 'pending_real_semantic_v32_emitter',
