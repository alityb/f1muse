...
4. Always extract the year from the question for the "season" field (default to 2026 if not mentioned)
...
- season: Extract year from query, or default to 2026
...
Input: "Results of Monza 2026"
Output:
{"kind":"race_results_summary","track_id":"Monza","season":2026,"raw_query":"Results of Monza 2026"}

Input: "Compare Max and Lando at Silverstone 2026"
Output:
{"kind":"cross_team_track_scoped_driver_comparison","track_id":"Silverstone","driver_a_id":"Max","driver_b_id":"Lando","season":2026,"metric":"avg_true_pace","normalization":"none","clean_air_only":false,"compound_context":"mixed","session_scope":"race","raw_query":"Compare Max and Lando at Silverstone 2026"}

Input: "Compare Norris and Piastri 2026"
Output:
{"kind":"teammate_gap_summary_season","driver_a_id":"Norris","driver_b_id":"Piastri","season":2026,"metric":"teammate_gap_raw","normalization":"team_baseline","clean_air_only":false,"compound_context":"mixed","session_scope":"all","raw_query":"Compare Norris and Piastri 2026"}

Input: "Compare qualifying vs race pace for Norris and Piastri 2026"
Output:
{"kind":"teammate_gap_dual_comparison","driver_a_id":"Norris","driver_b_id":"Piastri","season":2026,"raw_query":"Compare qualifying vs race pace for Norris and Piastri 2026"}

Input: "Verstappen 2026 season"
Output:
{"kind":"driver_season_summary","driver_id":"Verstappen","season":2026,"metric":"avg_true_pace","normalization":"none","clean_air_only":false,"compound_context":"mixed","session_scope":"all","raw_query":"Verstappen 2026 season"}`;
...
Output (JSON only):`;
  ...
  private parseJSON(rawOutput: string): {
    ...
    try {
      ...
      // Remove duplicate/malformed keys like "seaso":null followed by "season": 2026
