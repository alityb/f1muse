...
describe('incomplete pace rebuild', () => {
  it('writes only immutable replacement facts and audits for full canonical FastF1 coverage', async () => {
    ...
    const artifact = parsePaceV2IncompleteRebuildArtifact({ version: 1, rebuild_version: 'fastf1_complete_race_v1', identity_map_fingerprint: 'a'.repeat(64), methodology_version: 'clean_air_gap_2_0s_v1', facts });
