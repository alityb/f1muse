...
export const compositionalRegressionCorpusInput: unknown = {
  ...
  expected_coverage: {
    cases_total: 50,
    action_counts: { answer: 38, clarify: 5, abstain: 7 },
    split_counts: { development: 35, public_holdout: 3, ambiguity: 5, abstention: 7 },
    topology_counts: {
      single_source_rows: 19,
      single_source_aggregate: 10,
    ...
    source_set_counts: {
      ...
      qualifying_classification: 7,
      event_metadata: 7,
      event_classification_event_metadata: 4,
      event_classification_qualifying_classification: 3,
    ...
    coverage_tag_counts: {
      promoted_topology: 35,
      public_holdout: 3,
      ambiguity: 5,
      abstention: 7,
      plan_family_single_source: 29,
  ...
  cases: [
    ...
    {
      id: 'family-unfiltered-aggregate-locality', split: 'development', question: UNFILTERED_COMPOSE,
      coverage_tags: ['promoted_topology', 'plan_family_aggregate_locality'],
      risk_tags: ['aggregate_locality'], entities: [], provider_mode: 'enumerated',
      resolver: noResolvers,
      expected: {
        action: 'answer', reason: 'semantic_plan_proven', topology: 'scalar_aggregate_compose',
        source_ids: ['event_classification', 'qualifying_classification'], plan_family: 'aggregate_locality'
      }
    ...
    {
      id: 'family-selected-qualifying-count', split: 'development', question: SELECTED_QUALIFYING_COUNT,
      coverage_tags: ['promoted_topology', 'plan_family_single_source'],
      risk_tags: ['aggregation', 'resolver_identity', 'template_free'],
      entities: [
        { type: 'driver', text: 'Lando Norris' },
    ...
    {
      id: 'family-unfiltered-race-driver-count', split: 'development', question: UNFILTERED_RACE_DRIVER_COUNT,
      coverage_tags: ['promoted_topology', 'plan_family_single_source'],
      risk_tags: ['aggregation', 'template_free'], entities: [], provider_mode: 'enumerated', resolver: noResolvers,
      expected: {
        action: 'answer', reason: 'semantic_plan_proven', topology: 'single_source_aggregate',
    ...
    {
      id: 'family-unfiltered-qualifying-driver-count', split: 'development',
    ...
    {
      id: 'family-qualifying-count-ranking', split: 'development', question: QUALIFYING_COUNT_RANKING,
      coverage_tags: ['promoted_topology', 'plan_family_single_source'],
      risk_tags: ['aggregation', 'template_free'], entities: [], provider_mode: 'enumerated', resolver: noResolvers,
      expected: {
        action: 'answer', reason: 'semantic_plan_proven', topology: 'single_source_aggregate',
