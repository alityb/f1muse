...
export const launchParityManifest: readonly LaunchParityCase[] = [
  ...
  contracted('complete-final-standings', 'driver_season_summary', '2025 driver standings.', 'final_standings'),
  contracted('historical-complete-final-standings', 'driver_season_summary', '2023 driver standings.', 'final_standings'),
  ...
  contracted('comprehensive-replacement', 'driver_vs_driver_comprehensive', 'Compare the official 2025 results of Norris and Piastri.', 'official_driver_comparison'),
