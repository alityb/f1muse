...
export const answerEvaluationManifest: readonly AnswerEvaluationCase[] = [
  ...
  reviewed('iid-null', 'iid_holdout', 'How was Sample Driver classified in Australia 2025?', 'answer', 'race_classification', ['null_result'], [sampleRace]),
  reviewed('iid-tie', 'iid_holdout', 'Which of Norris and Piastri had more final 2025 points if they tied?', 'answer', 'final_driver_standings', ['tie'], [pair]),
  reviewed('iid-empty', 'iid_holdout', 'When was missing 2025 round 30?', 'answer', 'race_date_metadata', ['empty_result'], [{ version: 1, root: { op: 'event_metadata', season: 2025, round: 30, session_scope: 'race' } }]),
