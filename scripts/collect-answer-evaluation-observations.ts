...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 94) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 94 || artifact.observations.length !== expectedObservationCount) {
