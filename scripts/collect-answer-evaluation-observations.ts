...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 106) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 106 || artifact.observations.length !== expectedObservationCount) {
