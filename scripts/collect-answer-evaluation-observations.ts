...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 102) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 102 || artifact.observations.length !== expectedObservationCount) {
