...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 105) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 105 || artifact.observations.length !== expectedObservationCount) {
