...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 100) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 100 || artifact.observations.length !== expectedObservationCount) {
