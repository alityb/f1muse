...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 86) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 86 || artifact.observations.length !== expectedObservationCount) {
