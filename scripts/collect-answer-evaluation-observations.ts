...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 110) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 110 || artifact.observations.length !== expectedObservationCount) {
