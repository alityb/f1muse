...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 96) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 96 || artifact.observations.length !== expectedObservationCount) {
