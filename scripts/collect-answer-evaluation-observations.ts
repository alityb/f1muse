...
async function main(): Promise<void> {
  ...
  if (answerEvaluationManifest.length !== 92) {
  ...
  try {
    ...
    if (uniqueCaseCount !== answerEvaluationManifest.length || uniqueCaseCount !== 92 || artifact.observations.length !== expectedObservationCount) {
