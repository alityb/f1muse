...
const PROBE_CORPUS_SHA256 = 'e179f96913f5ee8d57b5a105a5a428db7e3753a86ae8a34dcceccb140f5429c5';
const PROBE_CORPUS_INPUT_SHA256 = '48deacc5fe0f78eda88ab8c38aa57a958bd7691e5d3ece76b9eb70f298229cea';
const PROBE_SNAPSHOT_INPUT_SHA256 = '3abfd85483332b92dfc97a341cd45ee65bf61a4b72732443139d05766d694a41';
...
const PROBE_PROVIDER_IDENTITY = Object.freeze({
  ...
  prompt_sha256: '39ee2574fdeebf50c2deb311e11a1b06a653e2560d202f844b6c8e213ecaaeec',
...
function matchesPinnedFixtureInputs(corpusInput: unknown, snapshotInput: unknown): boolean {
  ...
  return sha256(stableSerialize(corpusInput)) === PROBE_CORPUS_INPUT_SHA256 &&
    ...
    Array.isArray(corpusInput.cases) && corpusInput.cases.length === 28 &&
    snapshotInput.corpus_hash === PROBE_CORPUS_SHA256 &&
    Array.isArray(snapshotInput.cases) && snapshotInput.cases.length === 28;
}
