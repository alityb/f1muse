...
const PROBE_CORPUS_SHA256 = 'e75670f6af63603d941247d972ec9a4e209928c062fb2bbfa0f4eee55f396547';
const PROBE_CORPUS_INPUT_SHA256 = '4e31eb0084f86128c9443fe2cde3d39a02a28f01e42135dafc29758976f245ae';
const PROBE_SNAPSHOT_INPUT_SHA256 = '127652e6e582ca02313592f0852e71d13ea0b177c840955c844028b50ef85c13';
...
const PROBE_PROVIDER_IDENTITY = Object.freeze({
  ...
  prompt_sha256: '96c75a56ffaa98d9cb8e7fb2c432878041ea5f3e96cb41f4c6030c90acc71d77',
...
function matchesPinnedFixtureInputs(corpusInput: unknown, snapshotInput: unknown): boolean {
  ...
  return sha256(stableSerialize(corpusInput)) === PROBE_CORPUS_INPUT_SHA256 &&
    ...
    Array.isArray(corpusInput.cases) && corpusInput.cases.length === 44 &&
    snapshotInput.corpus_hash === PROBE_CORPUS_SHA256 &&
    Array.isArray(snapshotInput.cases) && snapshotInput.cases.length === 44;
}
